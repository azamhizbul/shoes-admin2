    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="insertPenjualanReseller" action="<?php echo base_url('adminroot/PenjualanAdmin/saveTransaksiResel'); ?>" method="post"> 
                    <!-- <form> -->
                        ...
                        <tbody>
                            <tr>
                               <td><h3 class="h3"><label class="h3" id="modalJumlahBarang" >0</label> - pasang</h3></td>
                                ...
                                <td><h3 class="h3">Rp. <label class="h3" id="modalTotalPembelanjaan">0</label><label id="labelAfterDiscount" class="label bg-green" style="font-size: 14px; margin-top: -5px;"></label></h3>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="form-group form-group-lg">
                        <div class="form-line">
                            <input id="date" type="date" name="tglJatuhTempo" class="form-control date" placeholder="Ex: 30/07/2016">
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function() {
        var options = {
            url: "<?php echo base_url('adminroot/PenjualanAdmin/getBarangResellJSON') ?>",
            getValue: "produk",
    ...
    function syncDicount(){
		...
		var rupiah = '';
		var angkaAfterDiscount = modalTB.toString().split('').reverse().join('');
		for (var i = 0; i < angkaAfterDiscount.length; i++) if (i%3 == 0) rupiah += angkaAfterDiscount.substr(i,3)+'.';
    ...
    $(".print").click(function(){
        ...
        jsonStr = JSON.stringify(obj);
        console.log(jsonStr);
        $.post("<?php echo base_url('adminroot/PenjualanAdmin/saveTransaksiResellPerItem'); ?>",
        {
            sendData: jsonStr
        },
    ...
    //     var obj2 = JSON.parse(jsonInvo);
    //     obj2['invoice'].push({"status_invoice":parseInt(0),"tanggal_jatuh_tempo":document.getElementById("date").value});
    //      jsonInvo = JSON.stringify(obj2);
    //     // console.log(jsonStr);
    //     $.post("<?php echo base_url('penjualan/penjualan/saveTransaksiResellInvo'); ?>",
    //     {
    //         invo: jsonInvo
    //     },
    //     function(data, status){
    ...
    //     var obj2 = JSON.parse(jsonInvoDetail);
    //     obj2['invoiceDetail'].push({"total_tagihan":parseInt(document.getElementById('SisaPembayaran').innerHTML),"pembayaran_tagihan":parseInt(0), "tanggal_pembayaran":document.getElementById('hari').value,"sisa_tagihan":parseInt(document.getElementById('SisaPembayaran').innerHTML)});
    //     jsonInvoDetail = JSON.stringify(obj2);
    //     console.log(jsonInvoDetail);
    //     $.post("<?php echo base_url('penjualan/penjualan/saveTransaksiResellInvoDetail'); ?>",
    //     {
    //         invoDetail: jsonInvoDetail
    //     },
    //     function(data, status){
    //         console.log( data); 
    //     });
