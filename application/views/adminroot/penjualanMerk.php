            ...
            <div class="body">
                <form>
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" id="Pro" class="form-control" placeholder="Masukan Kode Barang" autofocus onkeyup="validasi();">
                        </div>
                    </div>
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="insertPenjualanMerk" action="<?php echo base_url('adminroot/PenjualanAdmin/saveTransaksiMerk'); ?>" method="post">
                <div class="form-group hidden-xs hidden-sm hidden-ls hidden-md hidden-lg">
                    ...
                    <input type="number" name="sisaTagihan" id="sisaTagihan" placeholder="Sisa Tagihan">
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group form-group-lg">
                        <div class="form-line">
                            <input type="text" name="namaPembeli" class="form-control" placeholder="Masukan Nama Pembeli">
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><h3 class="h3">Rp. <label class="h3" id="modalTotalPembelanjaan">0</label> <span id="labelAfterDiscount" class="label bg-green" style="font-size: 14px; margin-top: -5px;"></span></h3></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-footer cs-rm-margin-btn" style="margin-top: 51px">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-primary waves-effect print">Tambah</button>
                </div>
            </form>
        </div> 
    </div>
...
<script>
    ...
    // Validation Form Penjualan Merk
    $('#insertPenjualanMerk').validate();
    ...
    $(document).ready(function () {
        var options = {
            url: "<?php echo base_url('adminroot/PenjualanAdmin/getBarangMerkJSON') ?>",
            ...
            list: {
                ...
                onClickEvent: function() {
                    ...
                    var harga = $("#Pro").getSelectedItemData().harga_jual_vendor;
    ...
    $(".print").click(function() {
        ...
        jsonStr = JSON.stringify(obj);
        console.log(jsonStr);
        $.post("<?php echo base_url('adminroot/PenjualanAdmin/saveTransaksiMerkPerItem'); ?>",
            {
                sendData: jsonStr
            },
