...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form id="form_advanced_validation" action="<?= base_url('adminroot/profile/simpanPassword'); ?>" method="POST">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?= base_url('adminroot/Profile/'); ?>" class="btn bg-red waves-effect">
