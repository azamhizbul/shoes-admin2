...
<div class="block-header">
    <h2>Informasi Bagian Penjualan</h2>
</div>
<!-- end title container -->
...
<div class="row">
    ...
    <!-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box-4 hover-zoom-effect">
            ...
            <div class="content">
                <div class="text">Total Pesanan /Bulan</div>
                <div class="number"><?= $pemesanan[0]->Total; ?></div>
                <a href="<?= base_url('penjualan/pemesanan/historyPemesanan'); ?>">Lihat</a>
            </div>
        </div>
    </div> -->
    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box-4 hover-zoom-effect">
            ...
            <div class="content">
                <div class="text">Total Pejualan /Bulan</div>
                <div class="number"><?= $penjualan[0]->Total; ?></div>
                <a href="<?= base_url('penjualan/penjualan/historyPenjualan/'); ?>">Lihat</a>
            </div>
        </div>
    </div>
    ...
    <!-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box-4 hover-zoom-effect">
            ...
            <div class="content">
                ...
                <div class="number"><?= $retur[0]->total_retur; ?></div>
                <a href="<?= base_url('penjualan/retur/'); ?>">Lihat</a>
            </div>
        </div>
    </div> -->
...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    Grafik Penjualan Bulan <?php echo date('M'); ?>
                </h2>
            </div>
            <div class="body">
...
<script>
    ...
    var customerUrl = '<?= base_url('penjualan/home/getDataJumlahPenjualanCustomer'); ?>';

    var resellerUrl = '<?= base_urL('penjualan/home/getDataJumlahPenjualanReseller'); ?>';
