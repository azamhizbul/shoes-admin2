        ...
        <div class="card">
            ...
            <div class="body">
                <div class="table-responsive cs-table-xflow">
                            ...
                            <?php 
                                if (!empty($laporanPengeluaranPerTahun)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <button class="btn btn-primary waves-effect btn-detail" data-toggle="modal" data-target="#defaultModal" id="<?= $data->BulanTahun; ?>">
                 ...
                 <?php 
                    if (!empty($laporanPengeluaranPerTahun)) { ?>
                        <a href="<?= base_url('adminroot/laporan_pengeluaran/printLaporanTahunan/'.$laporanPengeluaranPerTahun[0]->Tahun); ?>" title="Cetak Laporan" class="btn bg-light-green" target="_blank">
...
<script>
    $(".btn-detail").click(function(){
        ...
        $.post("<?php echo base_url('adminroot/LaporanPengeluaranTahunan/getBulanPengeluaranTahunan/') ?>",
    {
