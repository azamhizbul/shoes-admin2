...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="insertPenjualanEndUser" action="<?php echo base_url('adminroot/PenjualanAdmin/saveTransaksiEndUser'); ?>" method="post">
...
<script>
    ...
    // inisialisasi notif form input barang
    ...
    var options = {
        url: "<?php echo base_url('adminroot/PenjualanAdmin/getBarangEndJSON') ?>",
    ...
    $(".print").click(function() {
        ...
        jsonStr = JSON.stringify(obj);
        console.log(jsonStr);
        $.post("<?php echo base_url('adminroot/PenjualanAdmin/saveTransaksiEndPerItem'); ?>",
            {
                sendData: jsonStr
            },
