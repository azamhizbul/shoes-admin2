                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div>
                                        ...
                                        <h4>  Uang Kembalian : Rp. <?= strrev(implode('.',str_split(strrev(strval($detailpenjualan[0]->uang_kembalian)),3))); ?></h4>
                                    </div>
                                    <hr>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <?php if ($detailpenjualan[0]->reference_1 == 0) { ?>
                                        <a href="<?= base_url('adminroot/PenjualanAdmin/cetakBuktiPembayaranEndUserAdmin/'.$detailpenjualan[0]->id_transaksi_end_user); ?>" title="Cetak Bukti Pembayaran" target="_blank" class="btn bg-light-green">
                                            <i class="material-icons">print</i>
                                            <span>Cetak</span>
                                        </a>    
                                    <?php } else { ?>
                                        <a href="<?= base_url('adminroot/PenjualanAdmin/cetakBuktiPembayaranEndUserKasir/'.$detailpenjualan[0]->id_transaksi_end_user); ?>" title="Cetak Bukti Pembayaran" target="_blank" class="btn bg-light-green">
                                            <i class="material-icons">print</i>
                                            <span>Cetak</span>
                                        </a>
                                    <?php } ?>

                                    <a href="<?= base_url('adminroot/PenjualanAdmin/historyPenjualan/'); ?>" title="Kembali" class="btn bg-light-blue">
