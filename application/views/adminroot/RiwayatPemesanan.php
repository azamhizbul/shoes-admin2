    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="pull-left">Tanggal Pemesanan : <label id="tglPesanPending" style="font-weight: normal;"></label></p>
                <p class="pull-right">Karyawan : <label id="namaKaryawanPending" style="font-weight: normal;"></label></p>
...
<div class="modal fade" id="pesananSuksesModal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 id="namaVendor"></h3>
                <p class="pull-left">Tanggal Pemesanan : <label id="tglPesan" style="font-weight: normal;"></label></p>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form_advanced_validation" action="<?= base_url('adminroot/PemesananAdmin/tambahReturBarang'); ?>" method="POST" accept-charset="utf-8">
                    ...
                    <!-- <input type="hidden" name="totalBeliSukses" id="totalBeliSukses" placeholder="Total Beli" /> -->
...
<div class="modal fade" id="verifikasiPesananModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?= base_url('adminroot/PemesananAdmin/verifikasiPemesanan'); ?>" method="POST" accept-charset="utf-8">
...
<script>
    $(".btn-detail-pesanan-pending").click(function() {
        ...
        $.post("<?= base_url('adminroot/PemesananAdmin/detailRiwayatPemesananPending/'); ?>",
        {
    ...
    $(".btn-detail-pesanan-sukses").click(function() {
        ...
        $.post("<?= base_url('adminroot/PemesananAdmin/detailRiwayatPemesananSukses/'); ?>",
        {
    ...
    $(".btn-retur").click(function(){
        console.log(this.id);
        var idTransaksiVendor = this.id;
        $.post("<?php echo base_url('adminroot/PemesananAdmin/pemesananRetur/') ?>",
        {
            id: idTransaksiVendor
        },
        function(data, status){
