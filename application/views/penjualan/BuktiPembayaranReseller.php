	            ...
	            <div class="col-md-12 text-center"></div>
	         	<div class="row color-invoice">
	                <div class="col-md-12">
	                    ...
	                    <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <a href="<?= base_url('penjualan/penjualan/cetakBuktiPembayaranReseller/'.$detailpenjualan[0]->id_transaksi_reseller); ?>" title="Cetak Bukti Pembayaran" target="_blank" class="btn bg-light-green">
                                    <i class="material-icons">print</i>
                                    <span>Cetak</span>
                                </a>
                                <a href="<?= base_url('penjualan/penjualan/historyPenjualanReseller/'); ?>" title="Kembali" class="btn bg-light-blue">
