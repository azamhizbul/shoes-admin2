...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="insertPenjualanMerk" action="<?php echo base_url('penjualan/penjualan/saveTransaksiMerk'); ?>" method="post">
...
<script>
    ...
    $(document).ready(function () {
        var options = {
            url: "<?php echo base_url('penjualan/penjualan/getBarangMerkJSON') ?>",
    ...
    $(".print").click(function() {
        ...
        jsonStr = JSON.stringify(obj);
        console.log(jsonStr);
        $.post("<?php echo base_url('penjualan/penjualan/saveTransaksiMerkPerItem'); ?>",
            {
                sendData: jsonStr
            },
