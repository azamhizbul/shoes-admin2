            ...
            <div class="body">
                <div class="table-responsive cs-table-xflow">
                    <table class="table table-bordered table-striped table-hover dataTable js-basic-example cs-data-table">
                        ...
                        <tbody>
                            <?php if (!empty($listhistorypenjualanreseller)) {
                                $no = 1;

                                foreach ($listhistorypenjualanreseller as $penjualanreseller) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <td>
                                            <a href="<?php echo base_url('penjualan/penjualan/detailRiwayatPenjualanReseller/'.$penjualanreseller->id_transaksi_reseller); ?>" class="btn btn-primary waves-effect">
