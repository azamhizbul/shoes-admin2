    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?= site_url('gudang/home'); ?>" title="Gudang">GUDANG</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?= base_url('gudang/profile'); ?>"><i class="material-icons">person</i>Profile</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="<?= base_url('gudang/pesanan'); ?>">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li><a href="<?= base_url('gudang/stok'); ?>">Lihat Stok</a></li>
                            <li><a href="<?= base_url('gudang/stok/riwayatTambahStokBarang'); ?>">Riwayat Tambah Stok</a></li>
                        </ul>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 <a href="<?= site_url('gudang/home'); ?>">Shoes - POS Management</a>.
                </div>
                <div class="version">
                    <b>Version: </b> Beta
                </div>
