...
class Profile extends MY_Controller
{
	...
	function index() {
		...
		$this->render_gudang('gudang/profileUser', $data);
	}

	public function ubahPassword()
	{
		$data['title'] = 'Ubah Password';
		$this->render_gudang('gudang/UbahPassword', $data);
	}
	...
	public function simpanPassword()
	{
		...
		$this->form_validation->set_rules('konfirmPass', 'Konfirmasi Password', 'required|trim|matches[password]');
