...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form id="form_advanced_validation" action="<?= base_url('gudang/profile/simpanUsername') ?>" method="POST">
                    ...
                    <div class="form-group form-float">
                        <a href="<?= base_url('gudang/Profile/ubahPassword'); ?>" title="Ubah Password">Ubah Password</a>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?= base_url('gudang/home'); ?>" class="btn bg-red waves-effect">
